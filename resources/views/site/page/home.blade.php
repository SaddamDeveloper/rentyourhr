            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="{{ asset('site/assets/images/cat1.png') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="{{ asset('site/assets/images/cat2.png') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="{{ asset('site/assets/images/cat3.png')}}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4">
                        <img src="{{ asset('site/assets/images/cat4.png') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-lg-0">
                        <img src="{{ asset('site/assets/images/cat5.png') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-lg-0">
                        <img src="{{ asset('site/assets/images/cat6.png') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center mb-4 mb-md-0">
                        <img src="{{ asset('site/assets/images/cat7.png') }}" alt="category">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-category text-center">
                        <img src="{{ asset('site/assets/images/cat8.png')}}" alt="category">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="recent" role="tabpanel" aria-labelledby="home-tab">
                            <div class="single-job mb-4 d-lg-flex justify-content-between">
                                ...
                                <div class="job-img align-self-center">
                                    <img src="{{ asset('site/assets/images/job1.png') }}" alt="job">
                                </div>
                        ...
                        <div class="tab-pane fade" id="full-time" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="single-job mb-4 d-lg-flex justify-content-between">
                                ...
                                <div class="job-img align-self-center">
                                    <img src="{{ asset('site/assets/images/job2.png') }}" alt="job">
                                </div>
                                <div class="job-btn align-self-center">
                        ...
                        <div class="tab-pane fade" id="part-time" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="single-job mb-4 d-lg-flex justify-content-between">
                                ...
                                <div class="job-img align-self-center">
                                    <img src="{{ asset('site/assets/images/job3.png') }}" alt="job">
                                </div>
                                <div class="job-btn align-self-center">
                        ...
                        <div class="tab-pane fade" id="intern" role="tabpanel" aria-labelledby="contact-tab2s">
                            <div class="single-job mb-4 d-lg-flex justify-content-between">
                                ...
                                <div class="job-img align-self-center">
                                    <img src="{{ asset('site/assets/images/job4.png') }}" alt="job">
                                </div>
                                <div class="job-btn align-self-center">
