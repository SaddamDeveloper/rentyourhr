                ...
                <div class="box-body">
                    <form action="{{ route('admin.user.store') }}" method="post" name="user-add-frm" id="user-add-frm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="location">Company Location</label>
                                    <input type="text" name="location" class="form-control" id="location" placeholder="Company location">
                                </div>
                            </div>
                        </div>
                        <hr/>
